...
class PriceSheet implements FromArray, WithHeadings, WithEvents, ShouldAutoSize, WithTitle, WithMapping
{
    use CleanData;
    ...
    protected $brands;
    protected $sequence;
    protected $clientSheetTitle = 'Цены';
...
//                if ($this->countHeaders($this->headers) && count($this->categories) !== 0) {
//                    // CATEGORIES
